...
class Post extends Component{
    ...
    handleComment=()=>{
        axios.post(`/api/comment/${this.props.postid}`,{content:this.state.commentContent}).then(()=>{
                ...
                <div className ='post-container'>
                    ...
                    <div className = 'content-in'>
                        ...
                        <div className='likes'>
                            ...
                            <button className = 'comment-btn' onClick ={this.handleOpen}><i class="far fa-comments"></i></button>
                            <div className = 'modal-div'>
                                ...
                                <Fade in={this.state.comment}>
                                    <div className = 'comment-container'>
                                        ...
                                        {this.state.allComments.map((comments,index) =>{
                                        return(
                                        <>
                                        <Comments
                                        ...
                                        <div className = 'comments'>
                                            <div className = 'comment-input'>
                                                <TextField variant ='outlined' label = 'comment' name ='comment' onChange={this.handleChange} required ></TextField>
                                                <Button variant = 'contained' color ='primary' onClick = {this.handleComment}>Post</Button>
                                            </div>
                                        </div>
                                    </div>
                                </Fade>
